                ...
                <View style={styles.listContainer}>
                    {users.length>0 &&
                        <>
                            ...
                            {
                            users.map(item => 
                                <TouchableOpacity onPress={() => navigation.navigate('SStack', { screen: 'SOthersProfile', params: { id: item.userId} })} style={{flexDirection: 'row'}} activeOpacity={0.7} key={item._id}>
                                ...
                                <View style={styles.postInfoContainer}>
                                    ...
                                    <View style={styles.seeDetailsLinkContainer}>
                                        <View style={styles.seeDetailsLink}>
                                            <TouchableOpacity activeOpacity={0.7} onPress={() => navigation.navigate('SStack', { screen: 'SPostDetails', params: { id: item._id } })}>
